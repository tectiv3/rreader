...
<template>
    ...
    <AppLayout>
        ...
        <!-- Search input -->
        <div
            class="sticky top-14 z-20 border-b border-neutral-200 dark:border-neutral-800 bg-white/95 dark:bg-neutral-950/95 px-4 py-3 backdrop-blur">
            <div class="relative">
                <svg
        ...
        <div v-else-if="allArticles.length > 0">
            ...
            <div v-if="nextPageUrl" :ref="onSentinel" class="flex justify-center py-6">
                <div v-if="loadingMore" class="text-sm text-neutral-600 dark:text-neutral-500">
                    Loading more...
                </div>
            </div>
