        ...
        <div class="mx-auto max-w-lg px-4 py-6 space-y-5">
            ...
            <Transition
                ...
                <div
                    ...
                    class="rounded-lg bg-green-50 dark:bg-green-900/50 border border-green-300 dark:border-green-800 px-4 py-3 text-sm text-green-700 dark:text-green-300">
                    {{ status }}
                </div>
            </Transition>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                ...
                                @click="
                                    prefsForm.mark_read_on_scroll = !prefsForm.mark_read_on_scroll
                                "
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                ...
                                @click="
                                    prefsForm.hide_read_articles = !prefsForm.hide_read_articles
                                "
                                class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors"
                                :class="
            ...
            <!-- About -->
            <div class="rounded-xl bg-neutral-50 dark:bg-neutral-900 p-5">
                <h2 class="text-base font-medium text-neutral-800 dark:text-neutral-200 mb-3">
                    About
                </h2>
