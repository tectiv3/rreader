                    ...
                    >
                        ...
                        <div class="p-5">
                            ...
                            <div v-else>
                                ...
                                <!-- Feed preview -->
                                <div class="flex items-start gap-3 mb-5 rounded-lg bg-neutral-100 dark:bg-neutral-800 p-3">
                                    <img
                                    ...
                                    />
                                    <div v-else class="mt-0.5 h-6 w-6 rounded bg-neutral-300 dark:bg-neutral-700 shrink-0" />
                                    <div class="min-w-0 flex-1">
                                        <h3 class="text-sm font-medium text-neutral-900 dark:text-neutral-100 truncate">
                                            {{ preview.title || 'Untitled Feed' }}
                                        </h3>
                                        <p v-if="preview.description" class="mt-0.5 text-xs text-neutral-500 dark:text-neutral-400 line-clamp-2">
                                            {{ preview.description }}
                                        </p>
                                ...
                                <form @submit.prevent="subscribe">
                                    ...
                                    <!-- Category selection -->
                                    <div class="mb-4">
                                        <InputLabel for="add-feed-category" value="Category (optional)" />
                                        ...
                                        <InputError class="mt-2" :message="subscribeErrors.category_id" />
                                        <InputError class="mt-2" :message="subscribeErrors.new_category" />
                                    </div>
                                    ...
                                    >
                                        <svg v-if="isSubscribing" class="mr-2 h-4 w-4 animate-spin" viewBox="0 0 24 24" fill="none">
                                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" />
                                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
                                        </svg>
