...
<template>
                ...
                <div class="flex h-14 items-center justify-between border-b border-neutral-200 dark:border-neutral-800 px-4">
                    ...
                    <div class="flex items-center gap-1">
                        <Link
                            ...
                            class="rounded-lg px-2.5 py-1.5 text-xs font-medium text-blue-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 hover:text-blue-300 transition-colors"
                        >
                            Edit
                        </Link>
                        <button
                ...
                <nav class="flex-1 overflow-y-auto py-2" aria-label="Feed navigation">
                    ...
                    <div class="px-3 pb-2">
                        ...
                        <button
                            ...
                            :class="activeFilter === 'today' ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50'"
                        >
                            ...
                            <span v-if="sidebar.todayCount > 0" class="text-xs text-neutral-600 dark:text-neutral-500">{{ sidebar.todayCount }}</span>
                        </button>
                        ...
                        <button
                            ...
                            class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors cursor-pointer"
                            :class="activeFilter === 'read_later' ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50'"
                        >
                            ...
                            <span v-if="sidebar.readLaterCount > 0" class="text-xs text-neutral-600 dark:text-neutral-500">{{ sidebar.readLaterCount }}</span>
                        </button>
                    </div>
                    ...
                    <div class="px-3 pt-3">
                        <div class="flex items-center justify-between px-3 pb-2">
                            <h3 class="text-xs font-semibold uppercase tracking-wider text-neutral-600 dark:text-neutral-500">Feeds</h3>
                        </div>
                        ...
                        <button
                            @click="navigateTo({})"
                            class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors cursor-pointer"
                            :class="isActiveAll() ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50'"
                        >
                        ...
                        <div v-for="category in sidebar.categories" :key="category.id" class="mt-0.5">
                            <div
                                ...
                                :class="activeCategoryId === category.id ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50'"
                            >
                                <button
                                ...
                                >
                                    ...
                                    <span v-if="category.unread_count > 0" class="text-xs text-neutral-600 dark:text-neutral-500">{{ category.unread_count }}</span>
                                </button>
                            </div>
                            ...
                            <div v-if="isCategoryExpanded(category.id)" class="ml-4">
                                <button
                                    ...
                                    :class="activeFeedId === feed.id ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50 hover:text-neutral-700 dark:hover:text-neutral-300'"
                                >
                                    <img
                                        ...
                                        alt=""
                                    />
                                    <div v-else class="h-4 w-4 shrink-0 rounded-sm bg-neutral-300 dark:bg-neutral-700" />
                                    ...
                                    <span v-else-if="feed.unread_count > 0" class="text-xs text-neutral-600 dark:text-neutral-500">{{ feed.unread_count }}</span>
                                </button>
                            </div>
                        </div>
                        ...
                        <div v-if="sidebar.uncategorizedFeeds.length > 0" class="mt-0.5">
                            <button
                                ...
                                :class="activeFeedId === feed.id ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50'"
                            >
                                <img
                                    v-if="feed.favicon_url"
                                    :src="feed.favicon_url"
    ...
    <template v-else>
        <aside
            class="flex flex-col border-r border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900 transition-all duration-200"
            :class="collapsed ? 'w-16' : 'w-72'"
            aria-label="Navigation sidebar"
        >
            <!-- Sidebar header -->
            <div class="flex h-14 items-center border-b border-neutral-200 dark:border-neutral-800 px-3" :class="collapsed ? 'justify-center' : 'justify-between'">
                <h2 v-if="!collapsed" class="text-lg font-semibold text-neutral-900 dark:text-neutral-100 truncate">RReader</h2>
                <div class="flex items-center gap-1">
                    <Link
                        v-if="!collapsed"
                        :href="route('feeds.manage')"
                    ...
                    <button
                        ...
                        class="rounded-lg p-1.5 text-neutral-500 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-800 hover:text-neutral-800 dark:hover:text-neutral-200 transition-colors cursor-pointer"
            ...
            <nav class="flex-1 overflow-y-auto py-2" aria-label="Feed navigation">
                ...
                <div class="px-3 pb-2">
                    ...
                    <button
                        ...
                        :class="[
                            ...
                            activeFilter === 'today' ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50',
                        ]"
                    ...
                    <button
                        ...
                        :class="[
                            collapsed ? 'justify-center px-0 py-2.5' : 'px-3 py-2.5',
                            activeFilter === 'read_later' ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50',
                        ]"
                ...
                <div class="px-3 pt-3">
                    ...
                    <button
                        ...
                        :class="[
                            collapsed ? 'justify-center px-0 py-2.5' : 'px-3 py-2.5',
                            isActiveAll() ? 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100' : 'text-neutral-700 dark:text-neutral-300 hover:bg-neutral-200/50 dark:hover:bg-neutral-800/50',
                        ]"
                        :title="collapsed ? 'All Feeds' : undefined"
                    >
                        <svg class="h-5 w-5 shrink-0 text-neutral-500 dark:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12.75 19.5v-.75a7.5 7.5 0 00-7.5-7.5H4.5m0-6.75h.75c7.87 0 14.25 6.38 14.25 14.25v.75M6 18.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                        </svg>
                        <template v-if="!collapsed">
                            <span class="flex-1 text-left">All</span>
